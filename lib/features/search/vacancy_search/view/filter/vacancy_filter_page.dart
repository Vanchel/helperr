...
import 'package:helperr/features/edit_single_value/views/publication_age/edit_publication_age.dart';
import 'package:helperr/features/edit_single_value/views/publication_age/edit_publication_age_view.dart';
  ...
  Widget build(BuildContext context) {
    ...
    final searchQueryInput = Container(
      ...
      child: TextFormField(
        ...
        onSaved: (newValue) => _searchQuery = newValue,
      ),
    );
